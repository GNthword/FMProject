package com.milog.fm.annotation.processor.javac.handler;
...
import com.milog.fm.annotation.processor.javac.JavacNode;
...
public class FMHandler extends JavacAnnotationHandler<FM> {
